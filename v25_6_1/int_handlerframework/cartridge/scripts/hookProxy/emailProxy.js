 ...
 */
function sendEmail(emailObj, templateName, context) {
    var result;
    ...
    if (templateName) {
        ...
        emailData.messageBody = template.render(params).text;
    }
    ...
    if (emailObj) {
        switch(emailObj.type) {
            ...
            case emailTypes.contactUs:
                ...
                break;
            case emailTypes.passwordlessLoginToken:
                params.put('CurrentCustomer', context.passwordlessCustomer);
                params.put('PasswordlessToken', context.passwordlessToken);
                hookID += 'account.passwordlessLogin';
                break;
            default:
