 ...
 * @returns {void}
 */
base.authController = base.authController || function authController(req, res, next) {
 ...
 * @returns {void}
 */
base.validateRestoreSessionVarsEnabled = base.validateRestoreSessionVarsEnabled || function validateRestoreSessionVarsEnabled(req, res, next) {
