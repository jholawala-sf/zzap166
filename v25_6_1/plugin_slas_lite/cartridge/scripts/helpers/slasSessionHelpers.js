 ...
 */
base.getEncodedServiceCredentials = base.getEncodedServiceCredentials || function getEncodedServiceCredentials(serviceId) {
 ...
 */
base.getSessionVars = base.getSessionVars || function getSessionVars() {
 ...
 */
base.parseRequestBody = base.parseRequestBody || function parseRequestBody(req) {
 ...
 */
base.restoreSessionVars = base.restoreSessionVars || function restoreSessionVars(sessionVars) {
