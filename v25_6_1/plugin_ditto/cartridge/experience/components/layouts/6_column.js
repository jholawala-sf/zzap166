...
module.exports.render = function (context) {
    ...
    model.column4Width = PageRenderHelper.getColumnClasses(content.column4Width);
    model.column5Width = PageRenderHelper.getColumnClasses(content.column5Width);
    model.column6Width = PageRenderHelper.getColumnClasses(content.column6Width);
    ...
    return new Template('experience/components/layouts/6_column').render(model).text;
};
