...
class PDSpacing extends Component {
    constructor(props) {
        ...
        this.state = {
            disabled: false, loading: true, breakpoints: defaultBreakpoints
        };
    ...
    handleChange(value, type, position) {
        ...
        emit({
            type: 'sfcc:value', payload: { ...breakpoints }
        });
    ...
    render() {
        ...
        return (<>
            {loading ? (<Spinner size="small" variant="base" assistiveText={{ label: 'Small spinner' }} />) : (<>
                <div className="slds-m-bottom_x-small">
                    <BreakpointToggle activeBreakpoint={breakpoints.active} handleChange={this.handleBreakpointChange.bind(this)} />
                </div>
