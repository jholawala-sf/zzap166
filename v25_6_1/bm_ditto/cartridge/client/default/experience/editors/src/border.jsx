...
class PDBorderWidget extends Component {
    ...
    render() {
        const {
            activeBorder, disabled, icons, loading, borders
        } = this.state;
