...
class PDEinsteinRecommender extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(props) {
    var _this;
    super(props);
    _this = this;
    ...
    subscribe('sfcc:ready', /*#__PURE__*/function () {
      var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
        config,
        value
      }) {
        const recommenders = yield _this.retrieveRecommenders(config);
        if (!value) {
          value = {
            recommender: ''
          };
  ...
  retrieveAccessToken = (url, config) => {
    ...
    return new Promise(/*#__PURE__*/function () {
      var _ref2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        try {
          const response = yield fetch(`https://${url.host}/dw/oauth2/access_token`, {
            method: 'POST',
            headers: {
  ...
  retrieveRecommenders = config => {
    ...
    // eslint-disable-next-line no-async-promise-executor
    return new Promise(/*#__PURE__*/function () {
      var _ref3 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        try {
          const url = new URL(document.baseURI);
          const accessToken = yield _this2.retrieveAccessToken(url, config);
          const response = yield fetch(`https://${url.host}/s/-/dw/data/v19_3/sites/${config.siteid}/ai/recommender_names`, {
            method: 'GET',
            headers: {
          ...
          if (body.recommenders) {
            body.recommenders.forEach(recommender => {
              if (!config.recommenderTypes || config.recommenderTypes && config.recommenderTypes.includes(recommender.recommenderType)) {
  ...
  handleChange = recommender => {
    ...
    this.setState({
      selectedRecommender: recommender
    });
  };
  render() {
    const {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, loading ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "Loading...") : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      ...
      key: "select-a-recommender",
      value: ""
    }, "Select a Recommender"), recommenders.map(rec => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("option", {
      key: rec,
      value: rec
    }, rec)))))));
  }
...
root.render(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(PDEinsteinRecommender, null));
}();
/******/ })()
;
