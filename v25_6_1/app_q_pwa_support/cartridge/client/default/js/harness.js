...
const PageDesignerPageContainer = React.lazy(async () => {
    ...
    return import(
        '@salesforce/retail-react-app/app/components/page-designer/pageDesignerPageContainer'
    )
})
// preload
import('@salesforce/retail-react-app/app/components/page-designer/pageDesignerPageContainer')
...
window.__CONFIG__ = {
    app: {
        ...
        overlays: ['page-designer-theme-home']
    }
}
