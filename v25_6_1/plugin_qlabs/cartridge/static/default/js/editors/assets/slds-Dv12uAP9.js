...
function sj(a, b2, c2, d2, e2, f2, g2) {
  if (c2) {
    if (b2.flags & 256) return b2.flags &= -257, d2 = Li(Error(p(422))), tj(a, b2, g2, d2);
...
var BUTTON_ICON = "SLDSButtonIcon";
...
var IconSettings = function IconSettings2(_ref) {
  var iconPath = _ref.iconPath, onRequestIconPath = _ref.onRequestIconPath, actionSprite2 = _ref.actionSprite, customSprite2 = _ref.customSprite, doctypeSprite2 = _ref.doctypeSprite, standardSprite2 = _ref.standardSprite, utilitySprite2 = _ref.utilitySprite, children = _ref.children;
  return /* @__PURE__ */ React.createElement(IconSettingsContext.Provider, {
    value: {
      iconPath,
      onRequestIconPath,
      actionSprite: actionSprite2,
      customSprite: customSprite2,
      doctypeSprite: doctypeSprite2,
      standardSprite: standardSprite2,
      utilitySprite: utilitySprite2
    }
  }, children);
};
...
const actionSprite = "/assets/symbols-CLxqpa1D.svg";
const utilitySprite = "/assets/symbols-al1cfWL1.svg";
const standardSprite = "/assets/symbols-Dm7PJ9UF.svg";
const doctypeSprite = "/assets/symbols-DmX3iLty.svg";
const customSprite = "/assets/symbols-Cd6mOH8b.svg";
function SLDSConfig({
  children
}) {
  return /* @__PURE__ */ jsx(IconSettings, { actionSprite, utilitySprite, standardSprite, doctypeSprite, customSprite, children });
}
export {
  BUTTON_ICON as B,
  COLOR_PICKER as C,
...
//# sourceMappingURL=slds-Dv12uAP9.js.map
